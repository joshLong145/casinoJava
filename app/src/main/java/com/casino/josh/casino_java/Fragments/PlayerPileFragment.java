...
import com.casino.josh.casino_java.Listeners.HumanPileOnClickListener;


/**
 * Created by josh on 11/6/18.
 */

public class PlayerPileFragment extends Fragment {

    /**
     * Constructor for Fragment, default constructor as Fragments cannot take arguments.
     */
    public PlayerPileFragment() {}
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pile.setOnClickListener(new HumanPileOnClickListener(this));
